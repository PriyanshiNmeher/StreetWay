            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.state}, ${selectedAddress.zipcode}, ${selectedAddress.phone}, ${selectedAddress.country}`:"No address found"}</p>
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between">
                        <span>Tax (2%)</span><span>{currency}{getCartAmount() + getCartAmount()*2/100}</span>
                    </p>
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary-dull text-white font-medium hover:bg-primary-dull transition">
