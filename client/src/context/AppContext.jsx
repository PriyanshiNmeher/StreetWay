...
export const AppContextProvider = ({children})=>{
    ...
    if (sellerToken) {
        // ✅ Alag header - Authorization ko overwrite nahi karega
        axios.defaults.headers.common['seller-token'] = `Bearer ${sellerToken}`;
    } else {
    ...
    try {
        ...
        if (data.success) {
            ...
            setIsSeller(false)
            localStorage.removeItem("sellerToken")  // ✅ clear karo
            delete axios.defaults.headers.common['seller-token']
        }
    } catch (error) {
        setIsSeller(false)
